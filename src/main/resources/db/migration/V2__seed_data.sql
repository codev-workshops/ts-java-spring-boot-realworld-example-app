...
('comment-1', 'Great article! This really helped me understand Spring Boot basics.', 'article-1', 'user-2', NOW() - INTERVAL '6 days', NOW() - INTERVAL '6 days'),
('comment-2', 'Thanks for sharing. The code examples are very clear.', 'article-1', 'user-3', NOW() - INTERVAL '6 days', NOW() - INTERVAL '6 days'),
('comment-3', 'Excellent best practices guide. I''ll be implementing these in my project.', 'article-2', 'user-1', NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days'),
('comment-4', 'Very comprehensive overview of microservices. Well written!', 'article-3', 'user-2', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),
('comment-5', 'Docker tutorial was exactly what I needed. Thanks!', 'article-4', 'user-1', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day');
